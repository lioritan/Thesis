...
class TreeRecursiveSRLStep(object):
    ...
    def pick_split_query(self):
        ...
        choose_deeper= self.cross_val_deepening()
    ...
    def cross_val_deepening(self):
        ...
        for i, (trn_idxs, tst_idx) in enumerate(fold_pairs):
            ...
            new_node=TreeRecursiveSRLStep(new_trn, new_trn_lbl, [], [], self.n, self.MAX_DEPTH, self.SPLIT_THRESH, True)
