# -*- coding: utf-8 -*-
"""
Created on Tue Dec 23 13:44:29 2014
...
class TreeRecursiveSRLStep(object):
    def __init__(self, objects, tagging, relations, steps_to_curr, n, MAX_DEPTH, SPLIT_THRESH, logfile, cond=False):
    ...
    def pick_split_query(self):
        ...
        if self.cond is True or self.MAX_DEPTH==0:
            if self.ig <= ig_from_one_retag(self.tagging): #no query is useful
                self.chosen_query=None
