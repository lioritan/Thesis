...
if __name__=='__main__':
    ...
    for f,(trn_idxs, tst_idxs) in enumerate(kfold):
        ...
        for d in [0,1,2]:
            ...
            blah1, blah2, num_new= solve_multiclass(trn, trn_ents, trn_lbl, tst, tst_ents, tst_lbl, relations, logfile1,
        ...
        with open('result_fold_%d.pkl'%(f), 'wb') as fptr:
            cPickle.dump((svm_accs[f,:,:,:, :], knn_accs[f,:,:,:, :], feature_nums[f,:,:]), fptr, -1)
